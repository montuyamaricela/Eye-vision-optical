            ...
            <div>
                <form action="login.php" method="POST">
                    <div class="form-input">
                        <p id="error" class="error"> The email and password you've entered is incorrect.
                        </p>
                        <label for="">Username:</label>
                        <input type="text" name="username" id="username" placeholder="Enter username" required>
                    </div>
                    <div class="form-input">
                        <p id="passwordError" class="error"> The password you've entered is incorrect. </p>
                        <label for="">Password:</label>
                        <input type="password" name="password" id="password" minlength="8" placeholder="Enter password"
                            required>
                    </div>
