...
<body>
    ...
    <section id="editModal" style="display: block">
        ...
        <div class="body">
            <form id="add-account-form" action="add-account.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="two-column-input">
                    ...
                    <div class="form-input">
                        ...
                        <input type="password" minlength="8" id="confirmPassword" name="confirmPassword" required>
                    </div>
                </div>
                <div class="two-column-input">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if ($profile){
                                                echo "<img class='profileImage'  src='$profile' alt='$Name'>";
                                        } else {
    ...
    if ($_SERVER["REQUEST_METHOD"] == 'POST'){
        ...
        if (mysqli_num_rows($result) > 0){
            echo "<script>
                ...
                document.getElementById('editModal').style.top = '75px';

                document.getElementById('emailError').style.display = 'flex';
                document.getElementById('emailError').innerHTML = 'Email already exists. Please use a different email.';
            ...
            if ($password != '' && $confirmPassword != ''){
                if ($password === $confirmPassword){
                    ...
                    $sqlAddUserInfo = "INSERT INTO user_info(Name, Email, Phone, Address) VALUES ('$name', '$email', '$phoneNumber', '$address')";
                    $queryInfo = mysqli_query($con, $sqlAddUserInfo);
                
                    $sqlAddAccount = "INSERT INTO accounts(Name, Email, Password, Status) VALUES('$name', '$email', '$password', '$status')";
                    $queryInfo_2 = mysqli_query($con,  $sqlAddAccount);

                    if($imageName){
			            $location = "../public/images/userProfile/$imageName";
                    ...
                    try {
                        ...
                        $mail->Body    = "
                                <h3>Hey $name,</h3>
                                Thanks for getting started with Eye Vision! We have created an account for you. 
                                <br/><br/> Now that your account has been created, you can login by clicking the link below. Thank you!<br/>
                                <a href='http://localhost/optical/shop/login.php'>Login here</a> 
                                <br/><br/>
