<?php
    ...
    $html = '
            ...
            <table style="border-top: 1px solid black;padding: 10px 0">
                <thead>
                    <tr >
                        <th width="60px" style="font-weight: bold;">Product ID</th>
                        <th width="180px"  style="font-weight: bold;">Name</th>
                        <th style="font-weight: bold;">Category</th>
                        <th width="60px" style="font-weight: bold;">Price</th>
                        <th  width="60px" style="font-weight: bold;">Stock</th>
                ...
                <tbody>';
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <tr style="padding:10px">
                            <td  width="60px">'.$row['ID'].'</td>
                            <td width="180px">'.$row['Name'].'</td>
                            <td>'.$row['Category'].'</td> 
                            <td width="60px">'.$row['Price'].'</td>               
                            <td  width="60px">'.$row['Stock'].'</td>
...
';
    ...
    $pdf->Output('products-report	.pdf', 'I');
?>