...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="../styles/dashboardGlobal.css?v=6">
...
<body>
    ...
    <section id="deleteConfirmation" style="display:none">
        <div class="box-content">
            ...
            <div>
                ...
                <form action="delete-category.php" id="delete-category-form" method="POST">
    ...
    <section id="category_editModal">
        <div class="modalheader">
            <h2 class="header">Products Category</h2>
            <div class="">
        ...
        <div class="body">
            <form id="products-category-form" action="products-category.php" method="POST">
            ...
            <div class="main-content">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actionButton">
                                            <div class="svgAction" onclick="displayProductCategoryDetails(this)">
                                            ...
                                            <div class="svgAction" onclick="displayCategoryDeleteConfirmation(this)">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                ...
                <div class="pagination">
                    <div>
                        ...
                        $pageURL = '';
                        if ($page_number >= 2) {
                            echo "<a href='products-category.php?page=" .
                                ($page_number - 1) .
                                "'> Prev </a>";
                        }
                        for ($curpage = 1; $curpage <= $total_pages; $curpage++) {
                            if ($curpage == $page_number) {
                                $pageURL .=
                                    "<a class = 'active' href='products-category.php?page=" .
                                    $curpage .
                                    "'>" .
                                    $curpage .
                                    ' </a>';
                                ...
                                $pageURL .=
                                    "<a href='products-category.php?page=" .
                                    $curpage .
                                    "'>" .
                                    $curpage .
                                    ' </a>';
...
<?php 
    ...
    if($_SERVER["REQUEST_METHOD"]== 'POST'){
        ...
        $checkCategory = "SELECT * FROM category WHERE Category_name = '$categoryName'";
        ...
        if (mysqli_num_rows($result) > 0){
            ...
            $updateCategory = "UPDATE category SET Category_name = '$categoryName' WHERE ID = '$id'";
